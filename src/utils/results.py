...
from src.utils.paths import (
    ...
    get_results_accuracy_comparison_path_with_svm,
)
...
def save_accuracy_comparison_with_svm(
    results: list[AccuracyResult],
    output_file: str | Path | None = None,
) -> Path:
    """Save the CSP+SVM and EEGNet accuracy comparison to CSV."""
    if output_file is None:
        output_file = get_results_accuracy_comparison_path_with_svm()
...
def load_accuracy_comparison_with_svm(
    input_file: str | Path | None = None,
) -> list[AccuracyResult] | None:
    """Load the CSP+SVM and EEGNet accuracy comparison from CSV."""
    if input_file is None:
        input_file = get_results_accuracy_comparison_path_with_svm()
