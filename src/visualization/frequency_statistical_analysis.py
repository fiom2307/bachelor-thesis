...
from src.utils.paths import (
    get_frequency_statistical_plot_path,
)
...
def plot_frequency_statistical_summaries(
    ...
    """
    Plot one statistical frequency relevance summary per comparison.
    """
    output_paths = []
    ...
    for comparison in COMPARISONS:
        ...
        output_path = get_frequency_statistical_plot_path(
            comparison.slug
        )
...
def _plot_comparison(
    ...
    """
    Create one mean relative relevance comparison plot.
    """
    band_labels = [
        row.frequency_band
        for row in rows
